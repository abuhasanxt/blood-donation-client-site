              ...
              <tbody>
                {currentFoods.map((food, index) => (
                  ...
                  >
                    ...
                    <td className="px-2 md:hidden lg:block py-2">{food.district}</td>
                    <td className="px-2 md:hidden lg:block py-2">{food.upazila}</td>
                    <td className="px-2 py-2">{food.blood_group_name}</td>
                    <td className="px-2 py-2 md:hidden lg:block">{food.location}</td>
                    <td className="px-2 py-2">{food.date}</td>
                    <td className="px-2 py-2">{food.time}</td>
                    <td className="px-2 py-2 md:hidden lg:block">{food.note || "N/A"}</td>
                    <td className="px-2 py-2">
                      <span
                        className={`px-2 py-1 text-xs font-semibold rounded ${
                          food.status === "requested"
